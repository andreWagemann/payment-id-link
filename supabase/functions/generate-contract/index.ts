...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (authorizedPersons && authorizedPersons.length > 0) {
      ...
      page1.drawText("Herr", { x: 100, y: height - 439, size: 8, font });

      // Vorname + Nachname
      page1.drawText(person1.first_name, { x: 175, y: height - 439, size: 8, font });
      page1.drawText(person1.last_name, { x: 330, y: height - 439, size: 8, font });

      // Geburtsort, Geburtsdatum, Nationalität
      if (person1.place_of_birth) {
        page1.drawText(person1.place_of_birth, { x: 130, y: height - 464, size: 8, font });
      }
      ...
      if (person1.nationality) {
        page1.drawText(person1.nationality, { x: 435, y: height - 464, size: 8, font });
      }

      // Privatadresse: Straße, PLZ, Stadt, Ländercode
      if (person1.private_street) {
        page1.drawText(person1.private_street, { x: 120, y: height - 484, size: 8, font });
      }
      if (person1.private_postal_code) {
        page1.drawText(person1.private_postal_code, { x: 270, y: height - 484, size: 8, font });
      }
      if (person1.private_city) {
        page1.drawText(person1.private_city, { x: 355, y: height - 484, size: 8, font });
      }
      if (person1.private_country) {
        page1.drawText(person1.private_country, { x: 505, y: height - 484, size: 8, font });
      }
      ...
      // Ausweisdokument
      page1.drawText("Ausweis", { x: 70, y: height - 538, size: 8, font });

      // Ausweisnummer
      if (person1.id_document_number) {
        page1.drawText(person1.id_document_number, { x: 199, y: height - 538, size: 8, font });
      }
      ...
      if (person1.id_document_issuing_authority) {
        page1.drawText(person1.id_document_issuing_authority, { x: 406, y: height - 538, size: 8, font });
      }
